package com.osmar.examen_android.ui.movies.upcoming
...
import com.osmar.examen_android.databinding.FragmentEaUpComingMoviesBinding
...
@AndroidEntryPoint
class EAUpComingMoviesFragment : Fragment() {

    private lateinit var binding: FragmentEaUpComingMoviesBinding
    private val viewModel:EAUpComingMoviesViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding = FragmentEaUpComingMoviesBinding.inflate(inflater,container,false)
        initElements()
        initStateUI()
        return binding.root
    }
        ...
        with(binding.rvImages){
            ...
            moviesList?.let {
                adapter = EAMoviesAdapter(moviesList){ movie ->
                    val action = EAUpComingMoviesFragmentDirections.actionEAUpComingMoviesFragmentToEADetailMovieFragment(movie.id)
